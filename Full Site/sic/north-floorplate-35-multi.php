...
<div role="main" id="content" class="clearfix">
	...
	<section class="extended col clearfix">
		<div class="floorplate-info">
			...
			<span class="fpdata last">Download<strong><a href="pdf/north-floor-35-multi.pdf" target="_blank" class="pdf">PDF</a></strong></span>												
		</div>
		<h2 class="sm">Floors 3-5&nbsp; |&nbsp; Multi-tenant Test Fit</h2>
